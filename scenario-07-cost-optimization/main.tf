...
# TODO: aws_sns_topic + aws_sns_topic_subscription — budget and alarm delivery
# TODO: module "batch_invoke_fn" — call modules/lambda_base; demonstrates batch inference patterns
